...
typedef enum {
    ...
    // Error messages
    STR_ERROR_SOCKET,
    STR_ERROR_INVALID_ADDRESS,
    STR_ERROR_CONNECTION_FAILED,
    STR_ERROR_USERNAME_PASSWORD_REQUIRED,
    STR_ERROR_USERNAME_TOO_SHORT,
    STR_ERROR_PASSWORD_TOO_SHORT,
    STR_ERROR_USER_EXISTS,
    STR_ERROR_REGISTRATION_FAILED,
    STR_ERROR_ACCOUNT_BANNED,
    STR_ERROR_ALREADY_LOGGED_IN,
    STR_ERROR_INVALID_CREDENTIALS,
    STR_ERROR_GENERIC,
    STR_ERROR_SERVER_DISCONNECTED,
    STR_SUCCESS_REGISTERED,
    STR_CONNECTED_LOGGING_IN,
    STR_ENTER_CREDENTIALS,
    // Password change messages
    STR_ERROR_CURRENT_PASSWORD_REQUIRED,
    STR_ERROR_PASSWORD_TOO_SHORT_8,
    STR_ERROR_PASSWORDS_DONT_MATCH,
    STR_SUCCESS_PASSWORD_CHANGED,
    STR_PROCESSING,
    // Inventory
    STR_INVENTORY,
    STR_EQUIPMENT,
